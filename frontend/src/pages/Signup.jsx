  ...
  return (
    <main className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-xl surface-panel p-8">
        <div className="mb-8">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-sky-300">Join OmniRepo AI</p>
          <h1 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Create your account</h1>
          <p className="mt-3 text-slate-400">Register with email and password to start exploring repository intelligence tools.</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-400">
          Already have an account? <Link to="/login" className="font-semibold text-slate-100 hover:text-white">Sign in</Link>.
        </div>
      </section>
    </main>
  );
